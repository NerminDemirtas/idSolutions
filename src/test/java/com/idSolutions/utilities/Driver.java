   ...
   */
    ...
    public static WebDriver getDriver() {
        if (driverPool.get() == null) {
          ...
          /*
          Depending on the browserType that will bbbe return from configuration.properties file switch statement will determine the ,and open the matching browser
           */
            switch (browserType) {
                case "chrome":
